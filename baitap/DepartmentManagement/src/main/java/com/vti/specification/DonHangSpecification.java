...
public class DonHangSpecification implements Specification<DonHang> {
	...
	public DonHangSpecification(String field, String operator, Object value) {
		super();
		this.field = field;
	...
	@Override
	public Predicate toPredicate(Root<DonHang> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
